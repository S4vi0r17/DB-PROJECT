...
import com.mycompany.IGU.CMedioPago;
...
public class CrearMedioDePago extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearMedioDePago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrearMedioDePago().setVisible(true);
            }
        });
    }
